...
const requiredPatterns = [
  ...
  {
    pattern: /(?=[\s\S]*function resolvePortfolioPositiveWatchRankingGate)(?=[\s\S]*正向买入门禁拦截)(?=[\s\S]*function buildPortfolioBuyPreparationRanking[\s\S]{0,900}resolvePortfolioPositiveWatchRankingGate)(?=[\s\S]*function buildPortfolioLaunchSetupRanking[\s\S]{0,900}resolvePortfolioPositiveWatchRankingGate)(?=[\s\S]*function buildPortfolioCashRedeploymentRankingItem[\s\S]{0,900}resolvePortfolioPositiveWatchRankingGate)(?=[\s\S]*function buildPortfolioThemeMomentumRankingItem[\s\S]{0,500}resolvePortfolioPositiveWatchRankingGate)(?=[\s\S]*function buildPortfolioRotationOpportunityRankingItem[\s\S]{0,500}resolvePortfolioPositiveWatchRankingGate)/,
    message: "positive portfolio rankings must use the stale-catchdown gate before surfacing buy-preparation, launch-setup, cash-redeployment, theme-momentum, or rotation-opportunity candidates."
  },
  {
